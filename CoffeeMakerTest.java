...
import static edu.ncsu.csc326.coffeemaker.Main.*;
...
public class CoffeeMakerTest {
	...
	{
		coffeeMaker.addInventory("3","-2", "1", "6");
	}
	...
	/**
	 * Following tests are to make sure that the recipe is actually being added
	 */
	@Test
	public void testRecipeAdd()
	{
		boolean recipeAdd = coffeeMaker.addRecipe(recipe1);
		assertTrue(recipeAdd);
	}

	@Test
	public void testRecipeAdd2()
	{
		boolean recipeAdd2 = coffeeMaker.addRecipe(recipe2);
		assertTrue(recipeAdd2);
	}
	...
	@Test
	public void testRecipeAdd4()
	{
		boolean recipeAdd4 = coffeeMaker.addRecipe(recipe4);
		assertTrue(recipeAdd4);
	}

	//Test should fail.
	@Test
	public void testRecipeAdd5()
	{
		boolean recipeAdd5 = coffeeMaker.addRecipe(recipe4);
		assertTrue(recipeAdd5);
		assertFalse(recipeAdd5);
	}
	...
	public void testMakeCoffee2()
	{
		...
		assertEquals(50, coffeeMaker.makeCoffee(1,75));
	}
	...
	{
		coffeeMaker.addRecipe(recipe3);
		assertEquals("Crusty", coffeeMaker.makeCoffee(3, 100));
	}
	...
	{
		String isDeleted = coffeeMaker.deleteRecipe(0);
